...
public class KThread {
	...
	private ThreadQueue getJoinQueue;
	/**
	 ...
	 */
	public KThread() {
		getJoinQueue = ThreadedKernel.scheduler.newThreadQueue(false);
	//	this.getJoinQueue.acquire(this);
	...
	public static void finish() {
        ...
        if((savedThread = currentThread.getJoinQueue.nextThread()) != null)
            savedThread.ready();
	...
	public void join() {
		...
		// Return immediately if the specified thread is already dead. 
		if(this.status == statusFinished){
			return;
		} 
		else{
			this.getJoinQueue.waitForAccess(currentThread);
			currentThread.sleep();
		}
